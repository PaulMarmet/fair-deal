    ...
    public static Map<VillagerProfession, Int2ObjectMap<TradeOffers.Factory[]>>  PROFESSION_TO_LEVELED_TRADE = Util.make(Maps.newHashMap(), (map) -> {
        map.put(VillagerProfession.FARMER, TradeOffers.copyToFastUtilMap(ImmutableMap.of(
                1, new TradeOffers.Factory[]{
                        new FairFactories.SellItemShardFactory(Items.WHEAT, 6, 15, 10, 4),
                        new FairFactories.SellItemShardFactory(Items.POTATO, 8, 18, 10, 4),
                        new FairFactories.SellItemShardFactory(Items.CARROT, 6, 13, 10, 4),
                        new FairFactories.SellItemShardFactory(Items.BEETROOT, 6, 18, 10, 4),
                        new FairFactories.SellItemShardFactory(Items.BREAD, 4, 5, 4, 3)},
                2, new TradeOffers.Factory[]{
                        new FairFactories.SellItemShardFactory(Blocks.PUMPKIN.asItem(), 2, 4, 20, 5),
                        new FairFactories.SellItemShardFactory(Items.PUMPKIN_PIE, 10, 8, 8, 15),
                        new FairFactories.SellItemShardFactory(Items.APPLE, 14, 10, 16, 15)},
                3, new TradeOffers.Factory[]{
                        new TradeOffers.SellItemFactory(Items.COOKIE, 2, 32, 7, 20),
                        new FairFactories.SellItemShardFactory(Blocks.MELON.asItem(), 8, 7, 14, 20)},
                4, new TradeOffers.Factory[]{
                        new TradeOffers.SellItemFactory(Blocks.CAKE, 4, 1, 12, 50),
        ...
        map.put(VillagerProfession.FISHERMAN, TradeOffers.copyToFastUtilMap(ImmutableMap.of(
                1, new TradeOffers.Factory[]{
                        ...
                        new FairFactories.SellItemShardFactory(Items.COAL, 10, 16, 5),
                        new FairFactories.ProcessItemShardFactory(Items.COD, 6, 2, Items.COOKED_COD, 7, 16, 10, 0.05F),
                        new FairFactories.SellItemShardFactory(Items.COD_BUCKET, 10, 1, 16, 15)},
                2, new TradeOffers.Factory[]{
                        new FairFactories.SellItemShardFactory(Items.COD, 12, 16, 25),
                        new FairFactories.ProcessItemShardFactory(Items.SALMON, 6, 6, Items.COOKED_SALMON, 8, 16, 30, 0.05F),
                        new FairFactories.SellItemShardFactory(Items.CAMPFIRE, 8, 1, 20)},
                3, new TradeOffers.Factory[]{
                        new FairFactories.SellItemShardFactory(Items.SALMON, 14, 16, 30),
                        new TradeOffers.SellEnchantedToolFactory(Items.FISHING_ROD, 2, 3, 70, 0.2F)},
                4, new TradeOffers.Factory[]{
                        new FairFactories.SellItemShardFactory(Items.TROPICAL_FISH, 12, 12, 30)},
                5, new TradeOffers.Factory[]{
                        new TradeOffers.SellItemFactory(Items.PUFFERFISH, 12, 6, 50),
        ...
        map.put(VillagerProfession.SHEPHERD, TradeOffers.copyToFastUtilMap(ImmutableMap.of(
                1, new TradeOffers.Factory[]{
                        new FairFactories.SellItemShardFactory(Blocks.WHITE_WOOL.asItem(), 8, 16, 5),
                        new FairFactories.SellItemShardFactory(Blocks.BROWN_WOOL.asItem(), 8, 16, 5),
                        new FairFactories.SellItemShardFactory(Blocks.BLACK_WOOL.asItem(), 8, 16, 5),
                        new FairFactories.SellItemShardFactory(Blocks.GRAY_WOOL.asItem(), 8, 16, 5),
                        new TradeOffers.SellItemFactory(Items.SHEARS, 4, 1, 10)},
                2, new TradeOffers.Factory[]{
                ...
                4, new TradeOffers.Factory[]{
                        new FairFactories.SellTagShardFactory(ItemTags.WOOL, 2, 1, 16, 5),
                        new FairFactories.SellTagShardFactory(ItemTags.BANNERS, 9, 1, 12, 15)},
                5, new TradeOffers.Factory[]{
        ...
        map.put(VillagerProfession.FLETCHER, TradeOffers.copyToFastUtilMap(ImmutableMap.of(
                1, new TradeOffers.Factory[]{
                        ...
                        new FairFactories.SellItemShardFactory(Items.ARROW, 4, 16, 4),
                ...
                2, new TradeOffers.Factory[]{
                        ...
                        new FairFactories.SellItemShardFactory(Items.BOW, 6, 4, 7)},
                3, new TradeOffers.Factory[]{
                        new FairFactories.BuyItemShardFactory(Items.STRING, 32, 16, 4),
                        new FairFactories.SellItemShardFactory(Items.CROSSBOW, 14, 2, 20)},
                4, new TradeOffers.Factory[]{
                ...
                5, new TradeOffers.Factory[]{
                        ...
                        new TradeOffers.SellPotionHoldingItemFactory(Items.ARROW, 8, Items.TIPPED_ARROW, 8, 4, 12, 30)})));
        map.put(VillagerProfession.LIBRARIAN, TradeOffers.copyToFastUtilMap(ImmutableMap.of(
                1, new TradeOffers.Factory[]{
                        ...
                        new FairFactories.SellItemShardFactory(Items.BOOK, 8, 3, 15, 15)},
                2, new TradeOffers.Factory[]{
                        new FairFactories.SellItemShardFactory(Items.LANTERN, 6, 1, 32, 10),
                ...
                3, new TradeOffers.Factory[]{
                        ...
                        new FairFactories.SellItemShardFactory(Items.GLASS, 12, 16, 10, 10)},
                4, new TradeOffers.Factory[]{
                        new FairFactories.SellItemShardFactory(Items.WRITABLE_BOOK, 14, 12,8, 30),
        ...
        map.put(VillagerProfession.CARTOGRAPHER, TradeOffers.copyToFastUtilMap(ImmutableMap.of(
                1, new TradeOffers.Factory[]{
                        ...
                        new FairFactories.SellItemShardFactory(Items.MAP, 10, 1, 30)},
                2, new TradeOffers.Factory[]{
                        new FairFactories.SellItemShardFactory(Items.GLASS_PANE, 14, 32, 10),
                        new TradeOffers.TypedWrapperFactory(ImmutableMap.of(
                                VillagerType.DESERT, new FairFactories.SellMapShardFactory(16, StructureTags.ON_SAVANNA_VILLAGE_MAPS, "filled_map.village_savanna", MapDecorationTypes.VILLAGE_SAVANNA, 12, 15),
                                VillagerType.SAVANNA, new FairFactories.SellMapShardFactory(16, StructureTags.ON_PLAINS_VILLAGE_MAPS, "filled_map.village_plains", MapDecorationTypes.VILLAGE_PLAINS, 12, 15),
                                VillagerType.PLAINS, new FairFactories.SellMapShardFactory(16, StructureTags.ON_TAIGA_VILLAGE_MAPS, "filled_map.village_taiga", MapDecorationTypes.VILLAGE_TAIGA, 12, 15),
                                VillagerType.TAIGA, new FairFactories.SellMapShardFactory(16, StructureTags.ON_SNOWY_VILLAGE_MAPS, "filled_map.village_snowy", MapDecorationTypes.VILLAGE_SNOWY, 12, 15),
                                VillagerType.SNOW, new FairFactories.SellMapShardFactory(16, StructureTags.ON_PLAINS_VILLAGE_MAPS, "filled_map.village_plains", MapDecorationTypes.VILLAGE_PLAINS, 12, 15),
                                VillagerType.JUNGLE, new FairFactories.SellMapShardFactory(16, StructureTags.ON_SAVANNA_VILLAGE_MAPS, "filled_map.village_savanna", MapDecorationTypes.VILLAGE_SAVANNA, 12, 15),
                                VillagerType.SWAMP, new FairFactories.SellMapShardFactory(16, StructureTags.ON_SNOWY_VILLAGE_MAPS, "filled_map.village_snowy", MapDecorationTypes.VILLAGE_SNOWY, 12, 15))),
                        new TradeOffers.TypedWrapperFactory(ImmutableMap.of(
                                VillagerType.DESERT, new FairFactories.SellMapShardFactory(16, StructureTags.ON_PLAINS_VILLAGE_MAPS, "filled_map.village_plains", MapDecorationTypes.VILLAGE_PLAINS, 12, 15),
                                VillagerType.SAVANNA, new FairFactories.SellMapShardFactory(16, StructureTags.ON_DESERT_VILLAGE_MAPS, "filled_map.village_desert", MapDecorationTypes.VILLAGE_DESERT, 12, 15),
                                VillagerType.PLAINS, new FairFactories.SellMapShardFactory(16, StructureTags.ON_SAVANNA_VILLAGE_MAPS, "filled_map.village_savanna", MapDecorationTypes.VILLAGE_SAVANNA, 12, 15),
                                VillagerType.TAIGA, new FairFactories.SellMapShardFactory(16, StructureTags.ON_PLAINS_VILLAGE_MAPS, "filled_map.village_plains", MapDecorationTypes.VILLAGE_PLAINS, 12, 15),
                                VillagerType.SNOW, new FairFactories.SellMapShardFactory(16, StructureTags.ON_SNOWY_VILLAGE_MAPS, "filled_map.village_snowy", MapDecorationTypes.VILLAGE_SNOWY, 12, 15),
                                VillagerType.JUNGLE, new FairFactories.SellMapShardFactory(16, StructureTags.ON_DESERT_VILLAGE_MAPS, "filled_map.village_desert", MapDecorationTypes.VILLAGE_DESERT, 12, 15),
                                VillagerType.SWAMP, new FairFactories.SellMapShardFactory(16, StructureTags.ON_TAIGA_VILLAGE_MAPS, "filled_map.village_taiga", MapDecorationTypes.VILLAGE_TAIGA, 12, 15))),
                        new TradeOffers.TypedWrapperFactory(ImmutableMap.of(
                                VillagerType.DESERT, new FairFactories.SellMapShardFactory(16, StructureTags.ON_JUNGLE_EXPLORER_MAPS, "filled_map.explorer_jungle", MapDecorationTypes.JUNGLE_TEMPLE, 12, 15),
                                VillagerType.SAVANNA, new FairFactories.SellMapShardFactory(16, StructureTags.ON_JUNGLE_EXPLORER_MAPS, "filled_map.explorer_jungle", MapDecorationTypes.JUNGLE_TEMPLE, 12, 15),
                                VillagerType.PLAINS, new FairFactories.SellMapShardFactory(20, TagKey.of(RegistryKeys.STRUCTURE, Identifier.of("fair_deal", "on_ruin_maps")), "fair_deal.filled_map.ruins", MapDecorationTypes.RED_X, 12, 20),
                                VillagerType.TAIGA, new FairFactories.SellMapShardFactory(16, StructureTags.ON_SWAMP_EXPLORER_MAPS, "filled_map.explorer_swamp", MapDecorationTypes.SWAMP_HUT, 12, 15),
                                VillagerType.SNOW, new FairFactories.SellMapShardFactory(16, StructureTags.ON_SWAMP_EXPLORER_MAPS, "filled_map.explorer_swamp", MapDecorationTypes.SWAMP_HUT, 12, 15),
                                VillagerType.JUNGLE, new FairFactories.SellMapShardFactory(16, StructureTags.ON_SWAMP_EXPLORER_MAPS, "filled_map.explorer_swamp", MapDecorationTypes.SWAMP_HUT, 12, 15),
                                VillagerType.SWAMP, new FairFactories.SellMapShardFactory(16, StructureTags.ON_JUNGLE_EXPLORER_MAPS, "filled_map.explorer_jungle", MapDecorationTypes.JUNGLE_TEMPLE, 12, 15)))},
                3, new TradeOffers.Factory[]{
                        new FairFactories.BuyItemShardFactory(Items.COMPASS, 1, 9, 20,3),
                        new FairFactories.SellMapShardFactory(36, StructureTags.ON_OCEAN_EXPLORER_MAPS, "filled_map.monument", MapDecorationTypes.MONUMENT, 12, 50),
                        new FairFactories.SellMapShardFactory(38, StructureTags.ON_TRIAL_CHAMBERS_MAPS, "filled_map.trial_chambers", MapDecorationTypes.TRIAL_CHAMBERS, 12, 50)},
                4, new TradeOffers.Factory[]{
                        new TradeOffers.SellItemFactory(Items.ITEM_FRAME, 14, 1, 15),
                        new FairFactories.SellTagShardFactory(ItemTags.BANNERS, 12, 1, 12, 15)},
                5, new TradeOffers.Factory[]{
                        new TradeOffers.SellItemFactory(Items.GLOBE_BANNER_PATTERN, 9, 1, 50),
                        new TradeOffers.SellMapFactory(16, StructureTags.ON_WOODLAND_EXPLORER_MAPS, "filled_map.mansion", MapDecorationTypes.MANSION, 1, 70)})));
        map.put(VillagerProfession.CLERIC, TradeOffers.copyToFastUtilMap(ImmutableMap.of(
                1, new TradeOffers.Factory[]{
                        new FairFactories.SellItemShardFactory(Items.ROTTEN_FLESH, 8, 16, 5),
                ...
                3, new TradeOffers.Factory[]{
                        ...
                        new FairFactories.SellItemShardFactory(Blocks.GLOWSTONE, 16, 1, 12, 10)},
                4, new TradeOffers.Factory[]{
        ...
        map.put(VillagerProfession.ARMORER, TradeOffers.copyToFastUtilMap(ImmutableMap.of(
                ...
                2, new TradeOffers.Factory[]{
                        new FairFactories.SellItemShardFactory(Items.CHAINMAIL_BOOTS, 8, 1, 12, 10, 0.05F),
                        new FairFactories.SellItemShardFactory(Items.CHAINMAIL_HELMET, 9, 1, 12, 10, 0.05F),
                        new FairFactories.SellItemShardFactory(Items.CHAINMAIL_LEGGINGS, 14, 1, 12, 15, 0.05F),
                        new FairFactories.SellItemShardFactory(Items.CHAINMAIL_CHESTPLATE, 16, 1, 12, 20, 0.05F)},
                3, new TradeOffers.Factory[]{
        ...
        map.put(VillagerProfession.WEAPONSMITH, TradeOffers.copyToFastUtilMap(ImmutableMap.of(
                1, new TradeOffers.Factory[]{
                        new FairFactories.BuyItemShardFactory(Items.COAL, 64, 12, 4),
                        new FairFactories.SellItemShardFactory(new ItemStack(Items.STONE_AXE), 6, 1, 12, 6, 0.2F),
                        new FairFactories.SellItemShardFactory(Items.STONE_SWORD, 4, 3, 1, 6)},
                2, new TradeOffers.Factory[]{
                        new FairFactories.BuyItemShardFactory(Items.IRON_INGOT, 32, 12, 4),
                        new TradeOffers.SellItemFactory(Items.BELL, 20, 1, 12, 100, 0.2F)},
                3, new TradeOffers.Factory[]{
                        new FairFactories.SellItemShardFactory(Items.FLINT, 36, 12, 20)},
                4, new TradeOffers.Factory[]{
        ...
        map.put(VillagerProfession.BUTCHER, TradeOffers.copyToFastUtilMap(ImmutableMap.of(
                1, new TradeOffers.Factory[]{
                        new FairFactories.SellItemShardFactory(Items.CHICKEN, 6, 2, 2),
                        new FairFactories.SellItemShardFactory(Items.PORKCHOP, 8, 3, 3),
                        new FairFactories.SellItemShardFactory(Items.RABBIT, 4, 2, 3),
                        new FairFactories.SellItemShardFactory(Items.RABBIT_STEW, 6, 1, 3)},
                2, new TradeOffers.Factory[]{
                ...
                3, new TradeOffers.Factory[]{
                        new FairFactories.SellItemShardFactory(Items.MUTTON, 14, 16, 20),
                        new FairFactories.SellItemShardFactory(Items.BEEF, 20, 16, 20)},
                4, new TradeOffers.Factory[]{
                        new FairFactories.SellItemShardFactory(Items.DRIED_KELP_BLOCK, 10, 12, 30)},
                5, new TradeOffers.Factory[]{
