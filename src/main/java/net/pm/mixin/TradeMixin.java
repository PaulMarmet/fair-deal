...
public class TradeMixin {
    ...
    @Shadow
    private static TradeOffers.Factory createLibrarianTradeFactory(int experience) {return null;}

    @Shadow
    private static TradeOffers.Factory createMasterLibrarianTradeFactory() {return null;}

    @Final @Shadow private static TradeOffers.SellMapFactory SELL_DESERT_VILLAGE_MAP_TRADE;
    @Final @Shadow private static TradeOffers.SellMapFactory SELL_SAVANNA_VILLAGE_MAP_TRADE;
    @Final @Shadow private static TradeOffers.SellMapFactory SELL_PLAINS_VILLAGE_MAP_TRADE;
    @Final @Shadow private static TradeOffers.SellMapFactory SELL_TAIGA_VILLAGE_MAP_TRADE;
    @Final @Shadow private static TradeOffers.SellMapFactory SELL_SNOWY_VILLAGE_MAP_TRADE;
    @Final @Shadow private static TradeOffers.SellMapFactory SELL_JUNGLE_TEMPLE_MAP_TRADE;
    @Final @Shadow private static TradeOffers.SellMapFactory SELL_SWAMP_HUT_MAP_TRADE;
    ...
    public static Map<VillagerProfession, Int2ObjectMap<TradeOffers.Factory[]>>  PROFESSION_TO_LEVELED_TRADE = Util.make(Maps.newHashMap(), (map) -> {
        ...
        map.put(VillagerProfession.FISHERMAN, copyToFastUtilMap(ImmutableMap.of(
                ...
                5, new TradeOffers.Factory[]{
                        ...
                        new TradeOffers.TypeAwareBuyForOneEmeraldFactory(1, 12, 30, ImmutableMap.of(
        ...
        map.put(VillagerProfession.LIBRARIAN, copyToFastUtilMap(ImmutableMap.of(
                1, new TradeOffers.Factory[]{
                        new TradeOffers.BuyItemFactory(Items.PAPER, 24, 16, 2), createLibrarianTradeFactory(1),
                        new TradeOffers.SellItemFactory(Blocks.BOOKSHELF, 9, 1, 12, 1)},
                2, new TradeOffers.Factory[]{
                        new TradeOffers.BuyItemFactory(Items.BOOK, 4, 12, 10), createLibrarianTradeFactory(5),
                        new TradeOffers.SellItemFactory(Items.LANTERN, 1, 1, 5)},
                3, new TradeOffers.Factory[]{
                        new TradeOffers.BuyItemFactory(Items.INK_SAC, 5, 12, 20), createLibrarianTradeFactory(10),
                ...
                5, new TradeOffers.Factory[]{createMasterLibrarianTradeFactory(), new TradeOffers.SellItemFactory(Items.NAME_TAG, 20, 1, 30)})));
        map.put(VillagerProfession.CARTOGRAPHER, copyToFastUtilMap(ImmutableMap.of(
                ...
                2, new TradeOffers.Factory[]{
                        ...
                        new TradeOffers.TypedWrapperFactory(ImmutableMap.of(
                                ...
                                VillagerType.PLAINS, new TradeOffers.EmptyFactory(),
        ...
        map.put(VillagerProfession.ARMORER, copyToFastUtilMap(ImmutableMap.of(
                1, new TradeOffers.Factory[]{
                        new TradeOffers.BuyItemFactory(Items.COAL, 15, 12, 2),
                        new TradeOffers.BuyItemFactory(Items.IRON_INGOT, 5, 12, 2)},
                2, new TradeOffers.Factory[]{
                        TradeOffers.TypedWrapperFactory.of(
                                new TradeOffers.SellItemFactory(Items.IRON_BOOTS, 4, 1, 12, 5, 0.05F), VillagerType.DESERT, VillagerType.PLAINS, VillagerType.SAVANNA, VillagerType.SNOW, VillagerType.TAIGA),
                        TradeOffers.TypedWrapperFactory.of(
                                new TradeOffers.SellItemFactory(Items.CHAINMAIL_BOOTS, 4, 1, 12, 5, 0.05F), VillagerType.JUNGLE, VillagerType.SWAMP),
                        TradeOffers.TypedWrapperFactory.of(
                                new TradeOffers.SellItemFactory(Items.IRON_HELMET, 5, 1, 12, 5, 0.05F), VillagerType.DESERT, VillagerType.PLAINS, VillagerType.SAVANNA, VillagerType.SNOW, VillagerType.TAIGA),
                        TradeOffers.TypedWrapperFactory.of(
                                new TradeOffers.SellItemFactory(Items.CHAINMAIL_HELMET, 5, 1, 12, 5, 0.05F), VillagerType.JUNGLE, VillagerType.SWAMP),
                        TradeOffers.TypedWrapperFactory.of(
                                new TradeOffers.SellItemFactory(Items.IRON_LEGGINGS, 7, 1, 12, 5, 0.05F), VillagerType.DESERT, VillagerType.PLAINS, VillagerType.SAVANNA, VillagerType.SNOW, VillagerType.TAIGA),
                        TradeOffers.TypedWrapperFactory.of(
                                new TradeOffers.SellItemFactory(Items.CHAINMAIL_LEGGINGS, 7, 1, 12, 5, 0.05F), VillagerType.JUNGLE, VillagerType.SWAMP),
                        TradeOffers.TypedWrapperFactory.of(
                                new TradeOffers.SellItemFactory(Items.IRON_CHESTPLATE, 9, 1, 12, 5, 0.05F), VillagerType.DESERT, VillagerType.PLAINS, VillagerType.SAVANNA, VillagerType.SNOW, VillagerType.TAIGA),
                        TradeOffers.TypedWrapperFactory.of(
                ...
                4, new TradeOffers.Factory[]{
                        ...
                        TradeOffers.TypedWrapperFactory.of(
                                new TradeOffers.SellItemFactory(Items.IRON_LEGGINGS, 11, 1, 3, 15, 0.05F, TradeRebalanceEnchantmentProviders.DESERT_ARMORER_LEGGINGS_4), VillagerType.DESERT),
                        TradeOffers.TypedWrapperFactory.of(
                                new TradeOffers.SellItemFactory(Items.IRON_CHESTPLATE, 13, 1, 3, 15, 0.05F, TradeRebalanceEnchantmentProviders.DESERT_ARMORER_CHESTPLATE_4), VillagerType.DESERT),
                        TradeOffers.TypedWrapperFactory.of(
                        ...
                        TradeOffers.TypedWrapperFactory.of(
                                new TradeOffers.SellItemFactory(Items.IRON_LEGGINGS, 11, 1, 3, 15, 0.05F, TradeRebalanceEnchantmentProviders.PLAINS_ARMORER_LEGGINGS_4), VillagerType.PLAINS),
                        TradeOffers.TypedWrapperFactory.of(
                                new TradeOffers.SellItemFactory(Items.IRON_CHESTPLATE, 13, 1, 3, 15, 0.05F, TradeRebalanceEnchantmentProviders.PLAINS_ARMORER_CHESTPLATE_4), VillagerType.PLAINS),
                        TradeOffers.TypedWrapperFactory.of(
                        ...
                        TradeOffers.TypedWrapperFactory.of(
                                new TradeOffers.SellItemFactory(Items.IRON_HELMET, 3, 1, 3, 15, 0.05F, TradeRebalanceEnchantmentProviders.SAVANNA_ARMORER_HELMET_4), VillagerType.SAVANNA),
                        TradeOffers.TypedWrapperFactory.of(
                                new TradeOffers.SellItemFactory(Items.IRON_LEGGINGS, 5, 1, 3, 15, 0.05F, TradeRebalanceEnchantmentProviders.SAVANNA_ARMORER_LEGGINGS_4), VillagerType.SAVANNA),
                        TradeOffers.TypedWrapperFactory.of(
                                new TradeOffers.SellItemFactory(Items.IRON_CHESTPLATE, 7, 1, 3, 15, 0.05F, TradeRebalanceEnchantmentProviders.SAVANNA_ARMORER_CHESTPLATE_4), VillagerType.SAVANNA),
                        TradeOffers.TypedWrapperFactory.of(
                        ...
                        TradeOffers.TypedWrapperFactory.of(
                                new TradeOffers.SellItemFactory(Items.CHAINMAIL_BOOTS, 8, 1, 3, 15, 0.05F, TradeRebalanceEnchantmentProviders.JUNGLE_ARMORER_BOOTS_4), VillagerType.JUNGLE),
                        TradeOffers.TypedWrapperFactory.of(
                                new TradeOffers.SellItemFactory(Items.CHAINMAIL_HELMET, 9, 1, 3, 15, 0.05F, TradeRebalanceEnchantmentProviders.JUNGLE_ARMORER_HELMET_4), VillagerType.JUNGLE),
                        TradeOffers.TypedWrapperFactory.of(
                                new TradeOffers.SellItemFactory(Items.CHAINMAIL_LEGGINGS, 11, 1, 3, 15, 0.05F, TradeRebalanceEnchantmentProviders.JUNGLE_ARMORER_LEGGINGS_4), VillagerType.JUNGLE),
                        TradeOffers.TypedWrapperFactory.of(
                                new TradeOffers.SellItemFactory(Items.CHAINMAIL_CHESTPLATE, 13, 1, 3, 15, 0.05F, TradeRebalanceEnchantmentProviders.JUNGLE_ARMORER_CHESTPLATE_4), VillagerType.JUNGLE),
                        TradeOffers.TypedWrapperFactory.of(
                                new TradeOffers.SellItemFactory(Items.CHAINMAIL_BOOTS, 8, 1, 3, 15, 0.05F, TradeRebalanceEnchantmentProviders.SWAMP_ARMORER_BOOTS_4), VillagerType.SWAMP), TradeOffers.TypedWrapperFactory.of(new TradeOffers.SellItemFactory(Items.CHAINMAIL_HELMET, 9, 1, 3, 15, 0.05F, TradeRebalanceEnchantmentProviders.SWAMP_ARMORER_HELMET_4), VillagerType.SWAMP),
                        TradeOffers.TypedWrapperFactory.of(
                                new TradeOffers.SellItemFactory(Items.CHAINMAIL_LEGGINGS, 11, 1, 3, 15, 0.05F, TradeRebalanceEnchantmentProviders.SWAMP_ARMORER_LEGGINGS_4), VillagerType.SWAMP),
                        TradeOffers.TypedWrapperFactory.of(
                                new TradeOffers.SellItemFactory(Items.CHAINMAIL_CHESTPLATE, 13, 1, 3, 15, 0.05F, TradeRebalanceEnchantmentProviders.SWAMP_ARMORER_CHESTPLATE_4), VillagerType.SWAMP),
                        TradeOffers.TypedWrapperFactory.of(
                ...
                5, new TradeOffers.Factory[]{
                        TradeOffers.TypedWrapperFactory.of(
                                new TradeOffers.ProcessItemFactory(Items.DIAMOND, 4, 16, Items.DIAMOND_CHESTPLATE, 1, 3, 30, 0.05F, TradeRebalanceEnchantmentProviders.DESERT_ARMORER_CHESTPLATE_5), VillagerType.DESERT),
                        TradeOffers.TypedWrapperFactory.of(
                                new TradeOffers.ProcessItemFactory(Items.DIAMOND, 3, 16, Items.DIAMOND_LEGGINGS, 1, 3, 30, 0.05F, TradeRebalanceEnchantmentProviders.DESERT_ARMORER_LEGGINGS_5), VillagerType.DESERT),
                        TradeOffers.TypedWrapperFactory.of(
                                new TradeOffers.ProcessItemFactory(Items.DIAMOND, 3, 16, Items.DIAMOND_LEGGINGS, 1, 3, 30, 0.05F, TradeRebalanceEnchantmentProviders.PLAINS_ARMORER_LEGGINGS_5), VillagerType.PLAINS),
                        TradeOffers.TypedWrapperFactory.of(
                                new TradeOffers.ProcessItemFactory(Items.DIAMOND, 2, 12, Items.DIAMOND_BOOTS, 1, 3, 30, 0.05F, TradeRebalanceEnchantmentProviders.PLAINS_ARMORER_BOOTS_5), VillagerType.PLAINS),
                        TradeOffers.TypedWrapperFactory.of(
                                new TradeOffers.ProcessItemFactory(Items.DIAMOND, 2, 6, Items.DIAMOND_HELMET, 1, 3, 30, 0.05F, TradeRebalanceEnchantmentProviders.SAVANNA_ARMORER_HELMET_5), VillagerType.SAVANNA),
                        TradeOffers.TypedWrapperFactory.of(
                                new TradeOffers.ProcessItemFactory(Items.DIAMOND, 3, 8, Items.DIAMOND_CHESTPLATE, 1, 3, 30, 0.05F, TradeRebalanceEnchantmentProviders.SAVANNA_ARMORER_CHESTPLATE_5), VillagerType.SAVANNA),
                        TradeOffers.TypedWrapperFactory.of(
                                new TradeOffers.ProcessItemFactory(Items.DIAMOND, 2, 12, Items.DIAMOND_BOOTS, 1, 3, 30, 0.05F, TradeRebalanceEnchantmentProviders.SNOW_ARMORER_BOOTS_5), VillagerType.SNOW),
                        TradeOffers.TypedWrapperFactory.of(
                                new TradeOffers.ProcessItemFactory(Items.DIAMOND, 3, 12, Items.DIAMOND_HELMET, 1, 3, 30, 0.05F, TradeRebalanceEnchantmentProviders.SNOW_ARMORER_HELMET_5), VillagerType.SNOW),
                        TradeOffers.TypedWrapperFactory.of(
                                new TradeOffers.SellItemFactory(Items.CHAINMAIL_HELMET, 9, 1, 3, 30, 0.05F, TradeRebalanceEnchantmentProviders.JUNGLE_ARMORER_HELMET_5), VillagerType.JUNGLE),
                        TradeOffers.TypedWrapperFactory.of(
                                new TradeOffers.SellItemFactory(Items.CHAINMAIL_BOOTS, 8, 1, 3, 30, 0.05F, TradeRebalanceEnchantmentProviders.JUNGLE_ARMORER_BOOTS_5), VillagerType.JUNGLE),
                        TradeOffers.TypedWrapperFactory.of(
                                new TradeOffers.SellItemFactory(Items.CHAINMAIL_HELMET, 9, 1, 3, 30, 0.05F, TradeRebalanceEnchantmentProviders.SWAMP_ARMORER_HELMET_5), VillagerType.SWAMP),
                        TradeOffers.TypedWrapperFactory.of(
                        ...
                        TradeOffers.TypedWrapperFactory.of(
                                new TradeOffers.ProcessItemFactory(Items.DIAMOND, 4, 18, Items.DIAMOND_CHESTPLATE, 1, 3, 30, 0.05F, TradeRebalanceEnchantmentProviders.TAIGA_ARMORER_CHESTPLATE_5), VillagerType.TAIGA),
                        TradeOffers.TypedWrapperFactory.of(
                                new TradeOffers.ProcessItemFactory(Items.DIAMOND, 3, 18, Items.DIAMOND_LEGGINGS, 1, 3, 30, 0.05F, TradeRebalanceEnchantmentProviders.TAIGA_ARMORER_LEGGINGS_5), VillagerType.TAIGA),
                        TradeOffers.TypedWrapperFactory.of(
                                new TradeOffers.BuyItemFactory(Items.DIAMOND_BLOCK, 1, 12, 30, 42), VillagerType.TAIGA),
                        TradeOffers.TypedWrapperFactory.of(
                                new TradeOffers.BuyItemFactory(Items.IRON_BLOCK, 1, 12, 30, 4), VillagerType.DESERT, VillagerType.JUNGLE, VillagerType.PLAINS, VillagerType.SAVANNA, VillagerType.SNOW, VillagerType.SWAMP)})));
